...
from src.models.building_blocks import DoubleConv, ResNetBlock, ResNetBlockSE, \
...
class AbstractUNet(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, activation, basic_module, f_maps=64, layer_order='gcr',
...
class UNet3D(AbstractUNet):
    ...
    def __init__(self, in_channels, out_channels, activation='sigmoid', f_maps=64, layer_order='gcr',
...
class ResidualUNet3D(AbstractUNet):
    ...
    def __init__(self, in_channels, out_channels, activation='sigmoid', f_maps=64, layer_order='gcr',
                 num_groups=8, num_levels=4, is_segmentation=True, conv_padding=(1,1,1),
                 conv_upscale=2, upsample='default', dropout_prob=0.1, **kwargs):
